...
def deteccao_bordas_roberts(image):
...
if __name__ == "__main__":
    ...
    imagem_deteccao_bordas_roberts = deteccao_bordas_roberts(imagem)
    ...
    plt.subplot(1, 2, 2)
    plt.imshow(imagem_deteccao_bordas_roberts, cmap="gray")
    plt.title("Filtro para detecção de bordas (Roberts)")
    plt.axis("off")
